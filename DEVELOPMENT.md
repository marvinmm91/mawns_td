...
- [x] **Classic Mode** (`M`, Issue #54): Regulaere Bodengegner ignorieren Mauer, Palisade und Turm bei freiem oder alternativem Weg. Vollstaendige Sperren duerfen gebaut werden; ohne Weg greifen Bodengegner das gezielte Durchbruchziel mit zwanzigfachem Classic-Strukturschaden an, bis wieder ein Weg offen ist. Wrack, Luftgegner und stationaere Wachen sind ausgeschlossen. Classic bietet nur die Palisade neu an, bestehende andere Mauern bleiben kompatibel. Betroffene Dateien: `js/entities/enemies.js`, `js/systems/pathfinding.js`, `js/systems/building.js`, `js/config.js`, `GAME_DESIGN.md`, `tests/`. Akzeptanz: Freie Wege bleiben frei von Strukturangriffen; vollständige Einsperrungen sind baubar und werden zuverlässig aufgebrochen.
